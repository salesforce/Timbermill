...
public class TimberLogAdvancedTest {
    ...
    public void testOngoingTask() {
        ...
        TimberLogTest.waitForEvent(childTaskId, TaskStatus.SUCCESS);
        TimberLogTest.waitForEvent(ongoingTaskId, TaskStatus.SUCCESS);
    ...
    public void testOutOfOrderTaskError() {
        ...
        TimberLogTest.waitForEvent(taskId, TaskStatus.ERROR);
    ...
    public void testOutOfOrderTaskSuccessLogNoStart() {
        ...
        TimberLogTest.waitForEvent(taskId, TaskStatus.PARTIAL_SUCCESS);
        waitForValueInContext(ctx2, taskId);
    ...
    public void testOutOfOrderTaskErrorLogNoStart() {
        ...
        TimberLogTest.waitForEvent(taskId, TaskStatus.PARTIAL_ERROR);
        waitForValueInContext(ctx2, taskId);
    ...
    public void testOutOfOrderTaskStartLogNoSuccess() {
        ...
        TimberLogTest.waitForEvent(taskId, TaskStatus.UNTERMINATED);
        waitForValueInContext(ctx2, taskId);
    ...
    public void testOnlyLog() {
        ...
        TimberLogTest.waitForEvent(taskId, TaskStatus.PARTIAL_INFO_ONLY);
    ...
    public void testOngoingPrimaryTask() {
        ...
        TimberLogTest.waitForEvent(taskId1Arr[0], TaskStatus.SUCCESS);
    ...
    public void testOngoingTaskWithNullContext() {
        ...
        TimberLogTest.waitForEvent(finalTaskId, TaskStatus.SUCCESS);
    ...
    void testIncorrectTaskStartSuccessStartSuccess(boolean withUpdate) throws InterruptedException {
        ...
        TimberLogTest.waitForEvent(taskId, TaskStatus.CORRUPTED);
