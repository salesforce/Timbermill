...
public class TimberLogLocalTest extends TimberLogTest {
    ...
    public static void init(){
		...
		LocalOutputPipe pipe = new LocalOutputPipe.Builder().numberOfShards(1).numberOfReplicas(0).url(elasticUrl).deletionCronExp(null).diskHandlerStrategy(null).maxCacheHoldTimeMinutes(1)
