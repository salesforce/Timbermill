...
public class TimberLogLocalTest extends TimberLogTest {
    ...
    public static void init(){
		...
		pipe = new LocalOutputPipe.Builder().numberOfShards(1).numberOfReplicas(0).url(elasticUrl).deletionCronExp(null).diskHandlerStrategy(null).deletionCronExp("").orphansAdoptionsCronExp("").bulkPersistentFetchCronExp("").eventsPersistentFetchCronExp("").mergingCronExp("")
